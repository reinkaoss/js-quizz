...
function firstQuestion() {
  if (count === 0) {
    ...
    questions.textContent =
      "What programming language is used to style webpages?";
    appendButtonsQ1();
  }
}
...
function appendButtonsQ1() {
  ...
  text.forEach(function (el) {
    ...
    button.style.cssText =
      "display: flex; justify-content: center; align-text: center; margin: 0 auto; margin-top:10px;";
    button.dataset.index = el;
  });
}

// First question logic
var testIng = document
    ...
    if (element.matches("button")) {
      ...
      if (state === "CSS") {
        ...
        result.style.cssText =
          "color: green; text-align: center; font-size: 25px; font-weight: bolder;";
        ...
        resultWrong.style.cssText =
          "color: red; text-align: center; font-size: 25px; font-weight: bolder;";
        count = count - 25;
        // console.log(element)
      }
...
function secondQuestion() {
  ...
  secondQuestion.textContent =
    "Which of the options is NOT a value type in JavaScript?";
  appendButtonsQ2();
}
